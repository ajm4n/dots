...
namespace Processes
{
    public class PS
    {
        ...
        public string Execute(dynamic task)
        {
            ...
            StringBuilder resultsBuilder = new StringBuilder(); // Initialize a StringBuilder to store the results

            resultsBuilder.AppendLine("PID     PPID    Arch   Session   Owner" + new string(' ', biggestOwnerSize - 5) + "   Process Name");
            resultsBuilder.AppendLine("=====   =====   ====   =======   =====" + new string('=', biggestOwnerSize - 5) + "   ============");
            ...
            foreach (int pid in pids)
            {
                ...
                // Append the formatted information to the resultsBuilder
                resultsBuilder.AppendLine($"{pid.ToString()}{new string(' ', 8 - pid.ToString().Length)}{ppidString}{new string(' ', 8 - ppidString.Length)}{architecture}{new string(' ', 7 - architecture.Length)}{strSessID}{new string(' ', 10 - strSessID.Length)}{userName}{new string(' ', biggestOwnerSize - userName.Length + 3)}{process.ProcessName}");
            }
